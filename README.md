...
This Windows powershell script installs BepInEx dependency by default and installs any other [Thunderstore](https://thunderstore.io/c/lethal-company/p/) mods/modpacks you specify with the given format.
